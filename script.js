const translations = {
  fr: {
    meta_title: "styleme.fr — Ton agent IA du matin",
    nav_cta: "REJOINDRE LA LISTE →",
    hero_title: "« Qu'est-ce que je mets <em>demain matin</em> ? »",
    ...
    problem_text: "7h12. Tu es en retard. Tu ouvres ton armoire. Tu regardes. Tu ne sais pas quoi mettre. Tu essayes un haut, tu changes, tu re-changes. Tu finis par remettre la même chose qu'hier.",
    ...
    diff_1_right: "Te propose 2-3 max",
    ...
    faq_6_a: "Bien sûr. styleme.fr fonctionne pour tout le monde. Qu’importe ton style, ton genre ou tes goûts, l’IA s’adapte à toi.",
    footer_tagline: "Ton agent IA du matin",
  ...
  en: {
    meta_title: "styleme.fr — Your morning AI stylist",
    nav_cta: "JOIN THE LIST →",
    hero_title: "“What should I wear <em>tomorrow morning</em>?”",
    hero_sub: "Your AI stylist helps you get dressed every day without stress, ads, or pressure to buy.",
    ...
    faq_6_a: "Of course. styleme.fr works for everyone. Whatever your style, gender, or taste, the AI adapts to you.",
    footer_tagline: "Your morning AI stylist",
  ...
  es: {
    meta_title: "styleme.fr — Tu estilista IA de la mañana",
    nav_cta: "UNIRME A LA LISTA →",
    hero_title: "“¿Qué me pongo <em>mañana por la mañana</em>?”",
    hero_sub: "Tu estilista con IA te ayuda a vestirte cada día sin estrés, sin anuncios y sin empujarte a comprar.",
    ...
    step_2_title: "La IA te responde",
    ...
    faq_6_a: "Claro. styleme.fr funciona para todo el mundo. Sea cual sea tu estilo, género o gustos, la IA se adapta a ti.",
    footer_tagline: "Tu estilista IA de la mañana",
